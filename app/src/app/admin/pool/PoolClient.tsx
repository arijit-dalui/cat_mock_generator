        ...
        {!data ? (
          ...
          <div className="card mt-6 overflow-x-auto p-6">
            ...
            <p className="mt-4 text-xs text-slate-400">
              &quot;Below bar&quot; sets scored under MIN_QUALITY ({data.minQuality}) but still got pooled - a
              judge-rejected set that never made it into the pool at all isn&apos;t tracked anywhere yet, so a
              true accept/reject rate isn&apos;t shown here.
            </p>
          </div>
        )}
      </main>
