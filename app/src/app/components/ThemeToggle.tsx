...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      {theme === "light" ? (
        // Moon
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-slate-700" aria-hidden="true">
          <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79Z" />
        </svg>
      ) : (
        // Sun
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" className="text-amber-500" aria-hidden="true">
